...
<h3>🌍 PIXEL HOLE JUMP</h3>
<p>SPACE / CLICK để nhảy</p>
...
// ===== LEADERBOARD (LOCAL – SẼ ĐỔI FIREBASE) =====
...
function endGame() {
  ...
  setTimeout(() => {
    ...
    alert("📺 Quảng cáo hiển thị tại đây");

    let name = prompt("Game Over! Nhập nickname:");
    if (name) {
...
function draw() {
  ...
  ctx.fillText("↑ " + Math.floor(cameraY), 10, 40);
